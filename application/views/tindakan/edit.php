				...
				<div class="content-wrapper">
					<div class="row">
						<div class="col grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title fs-1 fw-bolder">Edit Data Tindakan</h4>
									<p class="card-description">
										Lorem ipsum dolor sit, amet consectetur adipisicing elit. Id, alias.
									</p>
									<form class="forms-sample" action="<?php echo base_url('tindakan/update/'.$detail['id_tindakan']) ?>"
										method="POST" enctype="multipart/form-data">
										<div class="form-group">
											<label for="id_tindakan">ID Tindakan</label>
											<input type="text" class="form-control" name="id_tindakan"
												value="<?php echo $detail['id_tindakan'] ?>" disabled>
										</div>
										<div class="form-group">
											<label for="nama_tindakan">Nama Obat</label>
											<input type="text" class="form-control" name="nama_tindakan" placeholder="Nama Tindakan"
												value="<?php echo $detail['nama_tindakan'] ?>">
										</div>
										<div class="form-group">
											<label for="biaya">biaya</label>
											<input type="number" class="form-control" name="biaya" placeholder="Rp."
												value="<?php echo $detail['biaya'] ?>">
										</div>
